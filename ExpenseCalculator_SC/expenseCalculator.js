        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                if (income <= 18550){ 
                 ...
                 taxRate = 33;
                    ...
                    tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                        (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
                        (231450 - 151900) * 0.33 + (income - 231450) * 0.35;
                    taxRate = 35;
                }
                 else {
                     tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
          ...
          *******************************************************************************/
                ...
                if (income <= 9275) {
                 ...
                 tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                       (151900 - 37650) * 0.25 + (115725 - 75950) * 0.28 +
                       (income - 115725) * 0.33;
                 taxRate = 33;
                }
                    ...
                    tax =  9275 * 0.10 + (37650 - 9275) * 0.15 +
                        ...
                        (151725 - 75950) * 0.33 + (income -115725) * 0.35;
                        taxRate = 35;
                }
                else {
                     tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                        (75950 - 37650) * 0.25 + (11725 - 75950) * 0.28 +
          ...
          *******************************************************************************/
                ...
                if (income <= 13250) {
                 ...
                 taxRate = 33;
                    ...
                    tax =  13250 * 0.10 + (50400 - 13250) * 0.15 +
                         (130150 - 50400) * 0.25 + (210800 - 130150) * 0.28 +
                        (210800 - 130150) * 0.33 + (income -210800) * 0.35;
                        taxRate = 35;
                }
                else {
                    tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
